...
public class TopicOccurrenceConstraintValidatorTest extends AbstractTest {
	...
	private static String testMapFile_04 = "./src/test/resources/topic-occurrence-constraint/test_case_04_map.ctm";
	private static String testSchemaFile_04 = "./src/test/resources/topic-occurrence-constraint/test_case_04_schema.ctm";
	...
	@Test // has additional other unconstrained occurrences
